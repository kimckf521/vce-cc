  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "VCE Specialist Mathematics", item: `${SITE_URL}/specialist` },
      ],
    },
  ],
};
      ...
      <section className="py-16 lg:py-20 px-5 sm:px-8 lg:px-12 bg-gray-50 dark:bg-gray-950/60">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">
            VCE Specialist past papers — free to browse
          </h2>
          <p className="text-base lg:text-lg text-gray-500 dark:text-gray-400 leading-relaxed mb-8 max-w-2xl mx-auto">
            Every VCAA Specialist Mathematics Exam 1 and Exam 2 from 2016 onwards, with step-by-step
            worked solutions for every question. No account needed to read them — pick a year and
            start practising.
          </p>
          <Link
            href="/vce/specialist/exams"
          ...
          >
            ...
            View all VCE Specialist past papers
