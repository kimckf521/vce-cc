  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "VCE General Mathematics", item: `${SITE_URL}/general` },
      ],
    },
  ],
};
      ...
      <section className="py-16 lg:py-24 px-5 sm:px-8 lg:px-12 bg-gradient-to-b from-brand-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Try General Maths free — no signup
            ...
            >
              Browse General Maths past papers
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-20 px-5 sm:px-8 lg:px-12 bg-gray-50 dark:bg-gray-950/60">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">
            VCE General Maths past papers — free to browse
          </h2>
          <p className="text-base lg:text-lg text-gray-500 dark:text-gray-400 leading-relaxed mb-8 max-w-2xl mx-auto">
            Every VCAA General Mathematics Exam 1 and Exam 2 from 2016 onwards — plus the older
            Further Maths papers that still make great practice — with worked solutions for every
            question. No account needed to read them.
          </p>
          <Link
            href="/vce/general/exams"
          ...
          >
            ...
            View all VCE General Maths past papers
